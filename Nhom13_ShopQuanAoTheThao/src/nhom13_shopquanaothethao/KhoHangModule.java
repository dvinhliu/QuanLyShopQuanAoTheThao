 ...
 * @author ACER
 */
public class KhoHangModule extends javax.swing.JFrame {

    /**
     * Creates new form KhoHangModule
     */
    Connection con;
    Product pro;
    KhoHangForm KHF;
    String sSize;
    public KhoHangModule(Product p, KhoHangForm kf) {
        initComponents();
        this.pro = p;
        this.KHF = kf;
        rdo_S.setText(pro.getProductSize());
        lbl_TinhTrang.setVisible(false);
        lbl_Tittle.setText(pro.getTensp() + " - Size: " + pro.getProductSize());
    }
    ...
    private void btn_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SaveActionPerformed
        ...
        else
        {
            ...
            {
                JOptionPane.showMessageDialog(rootPane, "Vui lòng nhập số lượng nhập hợp lệ", "Thông Báo", JOptionPane.INFORMATION_MESSAGE);
                return;
            }
        }
        for (int i = 0; i < KHF.tblmodel.getRowCount(); i++)
        {
            if (KHF.tblmodel.getValueAt(i, 1).toString().equals(pro.getTensp()) && KHF.tblmodel.getValueAt(i, 3).toString().equals(sSize))
            {
                KHF.tblmodel.setValueAt(txt_SL.getText(), i, 2);
                KHF.tblmodel.setValueAt(String.valueOf(Integer.parseInt(KHF.tblmodel.getValueAt(i, 2).toString()) * Integer.parseInt(KHF.tblmodel.getValueAt(i, 4).toString())), i, 5);
                KHF.GetTotal();
                txt_SL.setText("");
                txt_SL.requestFocus();
                return;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KhoHangModule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                Product p = new Product(null, kf, "",  "", "", "", "", 0, "");
                new KhoHangModule(p, kf).setVisible(true);
            }
        });
    }
